...
def fetch_media(handle,kind,mid):
    ...
    return {'media_id':v.get('id'),'desc':v.get('desc'),'create_time':v.get('createTime'),
...
targets=[
 ('@dianacmoreno_', [('video','7591308975946222879')]),
 ('@japanomars', [('video','7497614145798573330')]),
 ('@dailyblissna2', [('photo','7636260938626125057')]),
 ('@passportwithpurpose', [('photo','7597562767276526861')]),
 ('@travelwithwes', [('video','7623125371055017247')]),
]
out={}
for handle,medias in targets:
    ...
    time.sleep(4)
json.dump(out,open('verify4_results.json','w'),ensure_ascii=False,indent=1)
print('saved')
